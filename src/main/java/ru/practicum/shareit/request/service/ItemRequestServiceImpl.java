...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    public ItemRequestResponseDto getById(Long requestId) {
        ...
        List<ItemOwnerResponseDto> itemOwner = itemMapper.mapItemOwner(items);

        ItemRequestResponseDto itemRequestResponseDto = mapper.toItemRequestResponseDto(itemRequest, itemOwner);

        return itemRequestResponseDto;
    }

    @Override
    public List<ItemRequestResponseDto> getAll(int from, int size) {
