...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Page<Booking> findByBooker_IdAndStatusAndEndBefore(Long userId, BookingStatus status, LocalDateTime end, Pageable page);
    ...
    Page<Booking> findByOwnerIdAndStatus(Long userId, BookingStatus status, Pageable page);
    ...
    Page<Booking> findByOwnerIdAndStatusIsBefore(Long userId, BookingStatus approved, LocalDateTime localDateTime, Pageable page);
