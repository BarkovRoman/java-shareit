...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> add(ItemRequestDto itemDto, Long userId) {
    ...
    public ResponseEntity<Object> addComments(Long userId, Long itemId, CommentRequestDto commentDto) {
